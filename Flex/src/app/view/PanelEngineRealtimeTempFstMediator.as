package app.view
{
	...
	public class PanelEngineRealtimeTempFstMediator extends Mediator implements IMediator
	{
		public static const NAME:String = "PanelEngineRealtimeTempFstMediator";
		
		public function PanelEngineRealtimeTempFstMediator(viewComponent:Object=null)
		{
		...
		{	
			switch(notification.getName())
			{
				case ApplicationFacade.ACTION_UPDATE_ROPEWAY:
					panelEngineTempRealtime.engine = RopewayVO(notification.getBody()).engineFst;	
					break;
			}
		}		
	}
