package app.view
{
	...
	public class AlertMediator extends Mediator implements IMediator
	{
		...
		{
			return [
				Notifications.NOTIFY_ALERT_INFO,
				Notifications.NOTIFY_ALERT_ALARM,
				Notifications.NOTIFY_ALERT_ERROR
			];
		}
		...
		{			
			...
			{
				case Notifications.NOTIFY_ALERT_INFO:
				...
				case Notifications.NOTIFY_ALERT_ALARM:
					if(notification.getBody() is String)
					{
						info = notification.getBody() as String;
					}
				...
				case Notifications.NOTIFY_ALERT_ERROR:
					if(notification.getBody() is String)
					{
						info = notification.getBody() as String;
					}
