package forceMonitor.model
{
	...
	public class ConfigProxy extends WebServiceProxy implements IProxy
	{
		...
		{				
			...
			{
				sendNotification(ForceMonitorFacade.NOTIFY_ALERT_ERROR,"配置文件损坏，请检查config.xml文件正确性！");
				return;
			}
		...
		private function onInitDept(event:ResultEvent):void
		{
			...
			sendNotification(ForceMonitorFacade.NOTIFY_INIT_CONFIG_COMPLETE,config);
		}
	}
}