package forceMonitor.view
{
	...
	import forceMonitor.model.vo.RopewayForceAverageVO;
	import forceMonitor.model.vo.RopewayForceVO;
	import forceMonitor.model.vo.RopewayVO;
	import forceMonitor.view.components.PanelAnalysisForceAverage;
	...
	public class PanelAnalysisForceAverageMediator extends Mediator implements IMediator
	{
		...
		{
			sendNotification(ForceMonitorFacade.NOTIFY_ALERT_ALARM,"图形只能显示单一吊箱的数据，请先选择吊箱编号统计再切换至图形。");
		}		
