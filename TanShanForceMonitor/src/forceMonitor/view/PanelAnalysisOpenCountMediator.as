package forceMonitor.view
{
	...
	import forceMonitor.model.vo.RopewaySwitchFreqVO;
	import forceMonitor.model.vo.RopewayVO;
	import forceMonitor.view.components.PanelAnalysisOpenCount;
	...
	public class PanelAnalysisOpenCountMediator extends Mediator implements IMediator
	{
		...
		{
			sendNotification(ForceMonitorFacade.NOTIFY_ALERT_ALARM,"图形只能显示单一吊箱的数据，请先选择吊箱编号再切换至图形。");
		}			
