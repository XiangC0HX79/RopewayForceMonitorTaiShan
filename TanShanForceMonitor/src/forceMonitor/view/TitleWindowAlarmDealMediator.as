package forceMonitor.view
{
	...
	import forceMonitor.view.components.TitleWindowAlarmDeal;
	...
	public class TitleWindowAlarmDealMediator extends Mediator implements IMediator
	{
		...
		private function onOK(event:Event):void
		{
			...
			{
				sendNotification(ForceMonitorFacade.NOTIFY_ALERT_ALARM,"请输入处置信息。");
				return;
			}
		...
		{
			return [
				ForceMonitorFacade.NOTIFY_ROPEWAY_ALARM_DEAL
			];
		}
		...
		override public function handleNotification(notification:INotification):void
		{
			...
			{
				case ForceMonitorFacade.NOTIFY_ROPEWAY_ALARM_DEAL:
