package forceMonitor.view
{
	...
	public class AlertMediator extends Mediator implements IMediator
	{
		...
		{
			return [
				ForceMonitorFacade.NOTIFY_ALERT_INFO,
				ForceMonitorFacade.NOTIFY_ALERT_ALARM,
				ForceMonitorFacade.NOTIFY_ALERT_ERROR
			];
		}
		...
		{			
			...
			{
				case ForceMonitorFacade.NOTIFY_ALERT_INFO:
				...
				case ForceMonitorFacade.NOTIFY_ALERT_ALARM:
					if(notification.getBody() is String)
					{
						info = notification.getBody() as String;
					}
				...
				case ForceMonitorFacade.NOTIFY_ALERT_ERROR:
					if(notification.getBody() is String)
					{
						info = notification.getBody() as String;
					}
